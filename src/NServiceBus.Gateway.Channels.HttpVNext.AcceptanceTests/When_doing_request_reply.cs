        ...
        public class SiteA : EndpointConfigurationBuilder
        {
            public SiteA()
            {
                EndpointSetup<DefaultServer>(c =>
                {
                    ...
                    gatewaySettings.AddReceiveChannel("http://localhost:25699/SiteA/", "httpVNext");
                    gatewaySettings.AddSite("SiteB", "http://localhost:25699/SiteB/", "httpVNext");
                });
            }
        }
        ...
        public class SiteB : EndpointConfigurationBuilder
        {
            public SiteB()
            {
                EndpointSetup<DefaultServer>(c =>
                {
                    ...
                    gatewaySettings.AddReceiveChannel("http://localhost:25699/SiteB/", "httpVNext");
                });
            }
